package excecoes.exercicio2.banco.relatorios;

import excecoes.exercicio2.banco.dominio.*;
...
public class RelatorioClientes {
    ...
    public void geraRelatorio() {
        ...
        Iterator<Cliente> i = banco.getClientes();
        while (i.hasNext()) {
            cliente = i.next();
            System.out.println();
            System.out.println("Cliente: " + cliente.getNome() + ", " + cliente.getSobrenome());

            Iterator<Conta> j = cliente.getContas();
            while (i.hasNext()) {
                Conta conta = j.next();
                ...
                if (isContaCorrente) {
                    ...
                    System.out.println("\tCheque especial de " + (formatadorMonetario.format(contaCorrente.getChequeEspecial())));
                }
            }
        }
    }
